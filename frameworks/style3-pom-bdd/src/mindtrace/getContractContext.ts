...
/**
 * Contract Context Reader (additive):
 * Tests can call this to access the Automation Contract Context snapshot
 * that MindTrace CLI writes into run artifacts.
 *
 * Non-goals:
 * - No governance decisions
 * - Never throws (returns ok:false instead)
 */
