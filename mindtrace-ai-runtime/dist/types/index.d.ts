...
export type FailureCategory = 'dom_changed' | 'selector_failed' | 'api_error' | 'timeout' | 'navigation_mismatch' | 'ux_regression' | 'unexpected_modal' | 'environmental' | 'test_logic_error' | 'unknown';
...
export type SelectorStrategy = 'data_testid' | 'role' | 'text' | 'placeholder' | 'label' | 'css' | 'xpath';
...
export type ArtifactType = 'healed_selectors' | 'test_snippet' | 'failure_narrative' | 'root_cause_summary' | 'automation_suggestion' | 'jira_ticket' | 'steps_to_reproduce' | 'execution_trace' | 'coverage_gap_report';
